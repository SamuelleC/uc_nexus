...
export default function MBuilding() {
  const [floors] = useState<Floor[]>(() => generateFloors('M', 10, 10));

  return (
    <SafeAreaView className="flex-1 bg-gray-100">
      <Header title="M Building" subtitle="Rooms and availability" />
      <ScrollView className="p-6">
        <Text className="text-2xl font-bold mb-4 sr-only">M Building Rooms</Text>
