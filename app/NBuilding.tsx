...
export default function NBuilding() {
  const [floors] = useState<Floor[]>(() => generateFloors('N', 10, 10));

  return (
    <SafeAreaView className="flex-1 bg-gray-100">
      <Header title="N Building" subtitle="Rooms and availability" />
      <ScrollView className="p-6">
        <Text className="text-2xl font-bold mb-4 sr-only">N Building Rooms</Text>
