...
export default function SBuilding() {
  const [floors] = useState<Floor[]>(() => generateFloors('S', 10, 10));

  return (
    <SafeAreaView className="flex-1 bg-gray-100">
      <Header title="S Building" subtitle="Rooms and availability" />
      <ScrollView className="p-6">
        <Text className="text-2xl font-bold mb-4 sr-only">S Building Rooms</Text>
